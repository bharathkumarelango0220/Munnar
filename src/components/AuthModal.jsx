        ...
        <div className="p-5 sm:p-6">
          ...
          {user && user.isVerified && step === 'details' ? (
            ...
            <form onSubmit={handleSendOtp} className="space-y-3.5">
              ...
              {/* 100% Free 1-Click Google Sign In (Zero Spam, Instant Auth) */}
              <button
                type="button"
                disabled={isSubmitting}
                onClick={async () => {
                  ...
                  try {
                    ...
                    if (res && res.success && res.user) {
                      await loginUser({
                        ...
                        tripName: formData.tripName || 'Trip Expedition 2026'
                      });
                      setStep('success');
                      setTimeout(() => {
                        setIsAuthModalOpen(false);
                    ...
                    setError('Google Sign In cancelled or interrupted.');
                  } finally {
                    setIsSubmitting(false);
                  }
                }}
                className="w-full py-2.5 px-4 rounded-xl border border-slate-200 hover:bg-slate-50 text-slate-700 text-xs sm:text-sm font-bold flex items-center justify-center gap-2.5 transition-all shadow-xs active:scale-[0.99]"
              >
                ...
                <span>Continue with Google (1-Click Free)</span>
              </button>
